...
<head>
    ...
    <link rel="stylesheet" href="/css/theLastSessions.css">
...
<footer>
    <div>
        <form class="footer-form" action="#" method="POST">
            ...
            <button type="submit">عضویت در خبر نامه</button>

        </form>

    </div>
    <div class="footer-icons">
        <img src="imageAndIcons/logo_anjooman_senfi.png" alt="">
        <img src="imageAndIcons/logo_anjooman_senfi.png" alt="">
        <img src="imageAndIcons/logo_anjooman_senfi.png" alt="">
    </div>
    <ul>
    ...
    <div class="telegram">
        <a href="#"><img src="https://toplearn.com/img/telegram.svg" alt=""></a>
        <a href="#"><img src="https://toplearn.com/img/instagram.svg" alt=""></a>
    </div>
    <ul>
        <a href="#"><li>
                لرن بای
...
<p class="end">
    تمامی حقوق مادی و معنوی این سایت متعلق به تاپ لرن می باشد و هرگونه کپی برداری غیرقانونی محسوب خواهد شد
</p>
