...
<body>
@if(session()->has('err'))
    <p style="width: 100%;padding: 20px;display: flex;align-items: center;justify-content: center;background-color: #ff0000;color: white;font-size: 20px;position: relative" id="flashm">
        {{session('err')}}
...
<div class="header">
    ...
    <div class="links">
       ...
       <a href="/signin">ثبت نام در سایت</a>
    </div>
</div>
</div>
</body>
